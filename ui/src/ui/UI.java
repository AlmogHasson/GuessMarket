...
//                }
//                Scanner input = new Scanner(System.in);
//                //let the user choose an option and then choose amount of totalShares to buy
//                int optionNumber = getOptionNumber(input);
//                int totalShares = getSharesAmount(input);
//                participateUntilSuccessful(eventID, optionNumber, totalShares, input);
//            }
//            case CLOSE_EVENT -> {
//                displayEvents(controller.getEvents().stream().filter(event -> event.isOpen()).toList());
//                int eventID = getEventNumber(controller.getEvents().size());
...
//    }
//
//    private void participateUntilSuccessful(int eventID, int optionNumber, int totalShares, Scanner input) {
//        boolean participatedSuccessfully = false;
//
//        while (!participatedSuccessfully) {
//            try {
//                PurchaseDTO purchase = controller.participateInEvent(eventID, optionNumber, totalShares);
//                participatedSuccessfully = true;
//                displayDetailsAfterPurchase(purchase, eventID);
//            } catch (Exception e) {
//                System.out.println("Error occurred while participating in event: " + e.getMessage());
//                optionNumber = getOptionNumber(input);
//                totalShares = getSharesAmount(input);
//            }
//        }
//    }
//
...
//        System.out.print("Choose amount of totalShares to buy: ");
//        return input.nextInt();
//    }
//
